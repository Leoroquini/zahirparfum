        ...
        <div className="mx-auto grid max-w-[1440px] gap-6 md:grid-cols-2 md:gap-12">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-ink/80">
              <span className="font-display italic text-ink">Fresco</span>{" "}
              (cítricos, aquáticos, aromáticos leves) à esquerda → até{" "}
              <span className="font-display italic text-ink">Intenso</span>{" "}
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-ink/80">
              <span className="font-display italic text-ink">Seco</span>{" "}
              (especiados, fougères, amadeirados austeros) em cima → até{" "}
              <span className="font-display italic text-ink">Doce</span>{" "}
