  ...
  return (
    <section className="flex min-h-screen items-center justify-center px-6 py-24 md:px-12">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <h1 className="-mt-6 font-display text-3xl font-light tracking-tight text-cream md:text-5xl">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            href="/#catalogo"
            className="inline-flex items-center gap-3 rounded-full border border-cream/20 px-8 py-3.5 text-[11px] font-sans uppercase tracking-[0.3em] text-cream/80 transition-all hover:border-amber hover:text-amber"
          >
            Ver catálogo
          </Link>
        </div>
