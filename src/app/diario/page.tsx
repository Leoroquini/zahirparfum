...
function EmptyState() {
  return (
    ...
    >
      <div className="rounded-sm border border-amber/25 bg-ink-soft p-8 md:p-12">
        <span className="text-[10px] font-sans uppercase tracking-[0.4em] text-amber">
          Como funciona
        </span>
        <p className="mt-4 font-display text-3xl font-light leading-[1.15] text-cream md:text-4xl">
      ...
      <div className="rounded-sm border border-cream/8 bg-ink-soft p-6 md:p-8">
        ...
        <p className="mt-3 text-base leading-relaxed text-cream/75 md:text-lg">
          ...
          <em className="italic text-cream">acha</em> que prefere é diferente
    ...
    <div className="rounded-sm border border-cream/8 bg-ink-soft p-6 md:p-8">
      ...
      <div className="mt-5 flex flex-wrap gap-3">
        ...
        <button
          ...
          className="rounded-full border border-cream/15 px-5 py-2 text-[10px] font-sans uppercase tracking-[0.3em] text-cream/55 transition-all hover:border-wine hover:text-wine"
        >
          Apagar tudo
        </button>
      </div>
...
function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-ink/85 px-4 backdrop-blur-md">
      <motion.div
        initial={{ opacity: 0, scale: 0.96 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.3, ease: EASE_OUT }}
        className="w-full max-w-md rounded-sm border border-wine/40 bg-ink-soft p-6 md:p-8"
      >
        ...
        <p className="mt-3 text-base leading-relaxed text-cream/85">
          ...
          <em className="italic text-cream">não pode ser desfeita</em>.
        </p>
        ...
        <div className="mt-6 flex flex-wrap justify-end gap-3">
          <button
            type="button"
            onClick={onCancel}
            className="rounded-full border border-cream/20 px-5 py-2 text-[10px] font-sans uppercase tracking-[0.3em] text-cream/85 transition-all hover:border-amber hover:text-amber"
          >
            Cancelar
          </button>
          <button
            type="button"
            onClick={onConfirm}
            className="rounded-full bg-wine px-5 py-2 text-[10px] font-sans uppercase tracking-[0.3em] text-cream transition-all hover:bg-wine-deep"
          >
            Apagar tudo
          </button>
        </div>
