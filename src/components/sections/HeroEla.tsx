  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden pt-24">
      ...
      <div className="relative z-10 ml-auto flex w-full max-w-[680px] flex-col items-start px-6 text-left md:mr-12 md:px-12 lg:mr-24">
        ...
        >
          Perfume árabe pra mulher que sabe que cheirar bem não é só
          borrifar e sair —{" "}
        ...
        >
          {/* Primário rosé glass. CTA dominante do brief — "montar um kit
              de decants". Era href="#ritual", âncora que morreu quando o
              RitualEla saiu da home. */}
          <Link
          ...
          {/* Secundário cream. O brief define esta saída como
              "não sei por onde começar" → Ritual. */}
          <Link
            href="/ela/ritual"
